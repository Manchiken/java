...
set CLASSPATH=%APP_HOME%\lib\controller-v1.0-SNAPSHOT.jar;%APP_HOME%\lib\models-v1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.8.5.jar;%APP_HOME%\lib\annotations-12.0.jar
